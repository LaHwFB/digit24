...
//$Sql_Query = "select into app-test (name,email,phone_number) values ('$name','$email','$phone_number')";
$Sql_Query = "select from app-test where id=1 ";


 if(mysqli_query($con,$Sql_Query)){

 // If the record inserted successfully then show the message.
$MSG = 'Data selected Successfully into MySQL Database' ;
